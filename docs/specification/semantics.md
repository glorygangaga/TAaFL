...
- **Правило V6:** Присваиваемое выражение должно быть совместимо по типу с левой частью
...
- **Правило F4:** Параметру можно присваивать новые значения, как локальной переменной. Однако повторное объявление (`let`) переменной с тем же именем, что и у параметра, в той же области видимости запрещено
