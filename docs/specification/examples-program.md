...
| Fibonacci         | считает N-е число Фибоначчи                          | число            | N-е число Фибоначчи                   | двойная рекурсия, простые условия                       |
...
### Factorial — читает число N и считает его факториал N!, используя цикл либо рекурсию
