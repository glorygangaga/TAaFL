...
| ---------- | -------------------------------- | ---------- |
| `let`      | Объявление переменной            | Объявление |
| `const`    | Объявление константы             | Объявление |
| `print`    | Вывод данных                     | Ввод-вывод |
| `input`    | Ввод данных                      | Ввод-вывод |
| `func`     | Объявление функции               | Функции    |
| `return`   | Возврат из функции               | Функции    |
| `struct`   | Объявление структуры             | Структуры  |
| `if`       | Условное ветвление               | Управление |
| `elif`     | Альтернативное условие (else if) | Управление |
| `else`     | Альтернативная ветвь             | Управление |
| `for`      | Цикл for                         | Управление |
| `while`    | Цикл while                       | Управление |
| `switch`   | Множественное ветвление          | Управление |
| `case`     | Вариант в switch                 | Управление |
| `default`  | Вариант по умолчанию в switch    | Управление |
| `break`    | Прерывание цикла/switch          | Управление |
| `continue` | Продолжение цикла                | Управление |
| `and`      | Логическое И                     | Операторы  |
| `or`       | Логическое ИЛИ                   | Операторы  |
| `not`      | Логическое НЕ                    | Операторы  |
| `true`     | Булев литерал (истина)           | Литералы   |
| `false`    | Булев литерал (ложь)             | Литералы   |
