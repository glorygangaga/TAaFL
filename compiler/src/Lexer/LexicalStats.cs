...
public static class LexicalStats
{
  private static readonly HashSet<TokenType> Keywords = new()
  {
    ...
    TokenType.Func, TokenType.Return, TokenType.Struct, TokenType.Import, TokenType.Input, TokenType.Print,
  };
  ...
  private static readonly HashSet<TokenType> Operators = new()
  {
    ...
    TokenType.ColonTypeIndication, TokenType.DotFieldAccess, TokenType.OpenSquareBracket, TokenType.CloseSquareBracket,
